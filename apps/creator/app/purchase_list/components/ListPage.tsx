...
const ListPage = () => {
  const data = [
    { name: "Story Board Purchase", price: "$480", date: "10/08/24", creatorName: "Belle Erickson" },
    { name: "Story Board Purchase", price: "$480", date: "10/08/24", creatorName: "Belle Erickson" },
    { name: "Story Board Purchase", price: "$480", date: "10/08/24", creatorName: "Belle Erickson" },
    { name: "Story Board Purchase", price: "$480", date: "10/08/24", creatorName: "Belle Erickson" },
    { name: "Story Board Purchase", price: "$480", date: "10/08/24", creatorName: "Belle Erickson" },
    ...
    <section className=" md:p-[20px]">
      <div>
        <div className="flex items-center py-[20px] md:py-[30px] lg:py-[40px] px-[10px]">
          ...
          <h1 className=" text-[18px] md:text-[20px] lg:text-[28px] ml-[5px] md:ml-[10px] font-bold">Purchase Lists</h1>
        </div>
            ...
            <table className="w-full text-center bg-transparent border-separate border-spacing-y-3 px-[10px]">
              <thead>
                <tr className="text-gray-500 text-sm">
                  <th className="px-[15px] py-[10px] text-left">Name of Purchase</th>
