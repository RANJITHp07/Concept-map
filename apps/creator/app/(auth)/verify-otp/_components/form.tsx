    ...
    <div className="w-full md:w-1/2 p-4 md:p-8 flex flex-col justify-center items-center">
        <div className="flex justify-between items-center mb-8 md:mb-12">
          ...
          <div className="text-sm">
            Need help? <Link href="/contact" className="text-[#f5a623]">Contact Us</Link>
          </div>
        </div>
        ...
        <div className="max-w-md mx-auto w-full">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div>
              <label htmlFor="otp" className="block text-sm mb-2">Enter Verification Code</label>
          ...
          <div className="mt-6 text-center">
            <button className="text-[#f5a623] hover:underline">Resend Code</button>
          </div>
        </div>
      </div>
    </>
